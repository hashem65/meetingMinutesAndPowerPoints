...
x0 = [0.0060, 0.017, 0.00015, 0.0040, 0.0115, 0.00014, 0.0021, 0.0066, 0.00019, 0.0037, 0.0105, 0.00019]
...
doHarmonySearch = True

#print '************************************* Initial **********************************'
#printObjectiveEstimate(x0,fkeys,'BlockForInitialCondition')
#print '************************************* Initial **********************************'

bnds = [(2e-3,5e-2),(3e-3,5e-2),(5e-5,5e-3),(2e-3,5e-2),(3e-3,5e-2),(5e-5,5e-3),(2e-3,5e-2),(3e-3,5e-2),(5e-5,5e-3),(2e-3,5e-2),(3e-3,5e-2),(5e-5,5e-3)]
...
if doGlobalSearch:
    ...
    augmentedLagrnagePSO.setOption('SwarmSize',30)
